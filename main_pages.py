...
def astronaut_selection():
    if request.method == 'GET':
        ...
        answer = [request.form.get('lastname', ''), request.form.get('name', ''), request.form.get('email', ''),
                  request.form.get('class', ''), request.form.get('accept-engineer', ''),
                  request.form.get('accept-engineer2', ''), request.form.get('accept-pilot', ''),
                  request.form.get('accept-meteo', ''), request.form.get('accept-engineer3', ''),
                  request.form.get('accept-engineer4', ''), request.form.get('accept-doctor', ''),
                  request.form.get('accept-eczobio', ''), request.form.get('sex', ''),
                  request.form.get('about', ''), request.form.get('accept', ''), request.files['file'].read()]
